...
import '../styles/collapseFiche.scss'
...
const CollapseFiche = () => {
    ...
    let description = Fichelgt.description

return (

<div className='collapse-fiche'>
<div className='collapseF-item'>
         ...
         <div className={"CollapsF-text" + (open ? ' active' : '')} >{description}</div>
